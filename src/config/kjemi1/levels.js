const ammoniakk = 'AMMONIAKK.png';
const benzen = 'BENZEN.png';
const eddik = 'EDDIK.png';
const etanol = 'ETANOL.png';
const etylbutanat = 'ETYLBUTANAT.png';
const hcl = 'Hcl.png';
const hydrogen = 'HYDROGEN.png';
const karbon = 'KARBON.png';
const metan = 'METAN.png';
const nacl = 'NaCl.png';
const naoh = 'NaOH.png';
const o4 = 'O4.png';
const oksonium = 'OKSONIUM.png';
const oksygen = 'OKSYGEN.png';
const vann = 'VANN.png';
const blackhole = 'sorthull.png';
