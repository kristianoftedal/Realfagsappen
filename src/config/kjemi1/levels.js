...
const levels = [
  ...
  { 
    ...
    score: 2000,
    imageSource:  oksygen,
    text: 'Oksygen er grunnstoff nummer 8 og har en atommasse på 16,00 u. Dersom to oksygenatomer går sammen dannes det en upolar kovalent binding, og man får dannet oksygengass. Oksygengass er den gassen vi puster inn, og gjør det mulig kroppen og forbrenne næringen vi inntar. Oksygen møter du på i flere kapitler i Kjemi 1.',
  },
  {
    value: 'Metan',
    score: 4000,
    imageSource:  metan,
    text: 'Metan består av ett karbonatom og fire hydrogenatomer. Metan har en atommasse på 16,04 u. Metan er det enkleste organiske forbindelsen og regnes som et alkan. Metan regnes som en drivhusgass. Metan møter du i kapitelet «Organisk kjemi».',
  },
  {
    value: 'Ammoniakk',
    score: 7000,
    imageSource:  ammoniakk,
    text: 'Ammoniakk består av ett nitrogenatom og tre hydrogenatomer, og har en atommasse på 17,03 u. Ammoniakk er en giftig gass med stinkende lukt. Den regnes som en svak base, og er en dipol. Ammoniakk har historisk sett vært sentralt for norsk industri da Norsk Hydro brukte ammoniakk i produksjonen av kunstgjødsel. Ammoniakk lærer du mer om i «Kjemisk likevekt» og «Syrer og baser».'
  },
  {
    value:'Vann',
    score: 10000,
    imageSource:  vann,
    text: 'Vann består av ett oksygenatom og to hydrogenatomer og har en atommasse på 18,01 u. Alle kjenner til trivialnavnet vann, og svært få bruker det kjemiske navnet «Dihydrogenmonoksid». Vann utgjør størstedel av vekten til de fleste levende organismer og inngår i svært mange kjemiske reaksjoner. Vann møter du på i alle kapitler i Kjemi 1.'
  },
  {
    value:'Oksonium',
    score: 15000,
    imageSource:  oksonium,
    text: 'Oksonium har en atommasse på 19,00 u. Når en sterk eller svak syre gir fra seg et proton, kan dette bli tatt opp av et vannmolekyl (H2O) og danne oksonium. Konsentrasjonen av oksonium i en løsningen forteller oss hvilken pH løsningen har. Oksonium møter du på i kapitlet «Syrer og baser».'
  },
  {
    value:'Saltsyre',
    score: 20000,
  ...
  },
  {
    ...
    score: 30000,
    imageSource:  naoh,
    text: 'Natriumhydroksid er bedre kjent under navnet lut. NaOH er en sterk base med en atommasse på 40,00 u. Natriumhydroksid har svært mange bruksområder. Den brukes mye i industrien blant annet i produksjonen av papir. NaOH er en såpass sterk base at den kan brukes til å oppløse metaller og rense kjøtt fra dyreknokler. NaOH møter du i kapitelet «Syrer og baser».',
  },
  {
    value:'Etanol',
    score: 50000,
    imageSource:  etanol,
    text: 'Etanol er en enverdig, primæralkohol med atommasse 46,07 u. OH-gruppen i molekylet bidrar til at etanol er et godt polart løsemiddel. Samtidig har etanol blitt brukt som rusmiddel de siste 5.000 årene. Etanol er også et utgangsstoff for flere andre organiske stoffer, for eksempel etanal, eddiksyre og dietyleter. Etanol møter du i kapitelet «Organisk kjemi».'
  },
  { 
    value: 'NaCl',
    score: 100000,
    imageSource:  nacl,
    text: 'Natriumklorid er bedre kjent under navnet bordsalt og har en atommasse på 58,44 u. Natriumklorid består av to ioner, det positivt ladde natriumkationet og det negative kloranionet. Sammen danner disse en gitterstruktur som er typisk for salter. NaCl møter igjenn i «Uorganisk kjemi» og «Kjemiske bindinger».',
  },
  { 
    value: 'Eddiksyre',
    score: 200000,
  ...
  { 
    ...
    score: 750000,
    imageSource:  o4,
    text: 'Svovelsyre er en sterk to-protisk syre med atommasse 98,08 u. Svovelsyre er en oksosyre og er kjent for sin evne til å trekke vann ut av kjemiske stoffer. Den brukes dermed mye i industrien i produksjonen av nye kjemiske forbindelser. Svovelsyre møter du i «Uorganisk kjemi» og «Syrer og baser».',
  },
  { 
    value: 'Etylbutanat',
    score: 1000000,
    imageSource:  etylbutanat,
    text: ' Etylbutanat er en ester satt sammen av alkoholen etanol og karboksylsyren butansyre, og har en atommasse på 116,16 u. I likhet med de fleste estere har etylbutanat en god aroma – lukten av pære. Etylbutanat møter du i «Organisk kjemi».',
  },
  { 
    value: 'Sort hull',
    score: 30000000000000,
    imageSource:  blackhole,
    text: 'Et sort hull er den fysiske effekten av et objekt som har en masse tilsvarende 3-4 ganger solens og oppover, og som har ekstremt høy tetthet. Yttergrensen til et sort hull kalles hendelseshorisont, og innenfor denne er gravitasjonskreftene så store at ingenting kan unnslippe - ikke engang lys.',
  },
];
