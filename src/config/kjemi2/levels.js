...
const levels = [
  ...
  { 
    ...
    score: 1300,
    imageSource:  two,
    text: 'En reduksjon er en kjemisk reaksjon der et stoff tar imot ett eller flere elektroner. En reduksjon er det motsatte av en oksidasjon. Vitenskapsmenn har rangert stoffers evne til å bli redusert i en tabell som kalles for standard reduksjonspotensialetabellen eller spenningsrekka. Reduksjoner møter du i «Redoksreaksjoner» og «Elektrokjemi».'
  },
  { 
    value: 'Redoksreaksjon',
    score: 2300,
    imageSource:  three,
    text: 'En redoksreaksjon er en kombinasjonen av en oksidasjon og en reduksjon. Redoksreaksjoner kan enten regnes som spontane eller ikke-spontane redoksreaksjoner. Redoksreaksjoner leverer strøm i mye av den teknologien du bruker i hverdagen din, f.eks. når du regner på kalkulatoren eller lader telefonen din. Redoksreaksjoner møter du i «Redoksreaksjoner» og «Elektrokjemi».'
  },
  {
  ...
  },
  {
    ...
    score: 25000,
    imageSource:  nine,
    text: 'En kompleksdanner-reaksjon er en kjemisk reaksjon der det dannes et kompleksion som har ladning. Komplekseforbindelser er dermed løselige i vann. Mange av dem har sterke farger fordi et innskuddsmetall ofte er det sentrale ionet. Kompleksdannere møter du i «Uorganisk Kjemi» og «Organisk Kjemi».'
  },
  {
    value: 'Fellingsreaksjon',
    score: 30000,
    imageSource:  ten,
    text: 'En fellingsreaksjon er når ioner i en vannløsning går sammen, forlater løsningen, og legger seg som et bunnfall. Dette er fordi kreftene som bringer ionene sammen er sterkere enn vannets evne til å rive dem fra hverandre. Fellinger brukes mye i påvisningsreaksjoner. Du møter fellingsreaksjoner i «Uorganisk Kjemi» og «Organisk Kjemi».'
  },
  { 
  ...
  { 
    ...
    text: 'Eliminasjonsreaksjoner kjennetegnes av at et mindre molekyl forlater et større molekyl. Det lille molekylet er ofte vann. Det store produktet som blir igjen, har nesten alltid blitt gjort om til et alken eller et alkyn. Det er lett å forveksle eliminasjonsreaksjoner med kondensasjonsreaksjoner, så se etter dobbel- eller trippelbindinger. Eliminasjonsreaksjoner møter du i «Organisk Kjemi».'
  },
  { 
    value: 'Kondensasjonsreaksjon',
    score: 75000,
    imageSource:  fourteen,
    text: 'En kondensasjonsreaksjon er en kjemisk reaksjon der 2 molekyler går sammen og danner et større molekyl, samtidig som det spaltes av et lite molekyl, gjerne vann. Klassiske eksempler på kondensasjonsreaksjoner er dannelsen av estere og etere, samt mange biokjemiske reaksjoner, som dannelsen av fett og proteiner. Kondensasjonsreaksjoner møter du i «Organisk Kjemi» og «Næringsstoffer og Biokjemi».'
  },
  { 
