const photon = 'Foton3.png';
const electron = 'Elektron.png';
const proton = 'Proton3.png';
const atom = 'Atomkjerne2.png';
const hydrogen = 'Hydrogen.png';
const karbon = 'karbon.png';
const aminosyre = 'Molekyl.png';
const protein = 'Protein2.png';
const dna = 'DNA3.png';
const cellekjerne = 'Cellekjerne.png';
const celle = 'Celle.png';
const hjerte = 'Hjerte2.png';
const menneske = 'Menneske2.png';
const nuclear = 'Kjernekraftverk2.png';
const moon = 'moon.png';
const jorda = 'jord2.png';
const planet = 'Planetene.png'; 
const sol = 'Sol2.png';
const milky = 'Melkeveien2.png';
const univers = 'Universet2.png';
